...
## Merged Skill: Slack GIF Creator

This toolkit also absorbs the previous `slack-gif-creator` skill.

Use `references/slack-gif-creator-merge/` when the request is specifically about:

- Slack GIF size / color / FPS constraints
- turning artwork or frames into Slack-ready GIFs
- optimizing GIFs for emoji-style or message-style Slack usage

If the task is broader multimodal generation, stay in the main toolkit flow.
