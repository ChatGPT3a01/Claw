...
This local upgraded package also includes extra guides:

- `references/ppt-orchestra-workflow.md` for planning and orchestrating full multi-slide decks
- `references/ppt-editing-workflow.md` for template-based deck updates and XML-safe editing
- `references/slide-making-guide.md` for single-slide implementation details
- `references/pptxgenjs-single-slide.md` for extra PptxGenJS reference material

Use these together with `references/slide-types.md`, `references/design-system.md`, `editing.md`, and `pptxgenjs.md`.
